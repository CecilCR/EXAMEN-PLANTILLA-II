...
function mostrarResultados(aciertos) {
  ...
  const html = `
    ...
    <br>
    <button class="verde" onclick="verRevision()">Revisar respuestas</button>
...
function verRevision() {
  let html = "<h2>Revisión del examen</h2><hr><br>";
  ...
  html += `<button onclick="mostrarResultados(calcularAciertos())">← Volver a resultados</button>`;
